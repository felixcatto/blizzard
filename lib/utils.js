...
export const reactRenderPlugin = fp(async app => {
  app.addHook('preHandler', async (request, reply) => {
    reply.render = (viewPath, props = {}) => {
      const { template, viewsPath, urlFor, routes, isDevelopment } = app.ctx;
      ...
      const Component = require(absoluteViewPath).default; // eslint-disable-line
      ...
      const clientPageScript = `<script src="/js/${viewPath}.client.js"></script>`;
